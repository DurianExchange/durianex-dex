import { ChainId, Pair, Token } from '@durianexchange/sdk'
...
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token]): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB, FACTORY_ADDRESS, INIT_CODE), 18, 'Durian-LP', 'Durian LPs')
}
